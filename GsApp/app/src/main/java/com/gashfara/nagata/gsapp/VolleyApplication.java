...
public class VolleyApplication extends Application {
    ...
    //トラッキングIDを設定
    private static final String PROPERTY_ID = "UA-79135275-1";
    ...
    public void onCreate() {
        ...
        Kii.initialize(getApplicationContext(), "04233071", "d253030eaf66aff5e7c6b1a47bd0889e", Kii.Site.JP, true);//GrowthHack(ABテスト)修正。trueを追加してKiiAnalyticsを有効にする。
    }
